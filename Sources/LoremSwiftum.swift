...
public class Lorem {
    ...
    public static var sentence: String {
        let numberOfWordsInSentence = Int.random(lower: 4, 16)
    ...
    public static var paragraph: String {
        let numberOfSentencesInParagraph = Int.random(lower: 3,9)
    ...
    public static var title: String {
        let numberOfWordsInTitle = Int.random(lower: 2, 7)
        let capitalizeStringDecorator: (String) -> String = { $0.capitalize() }
    ...
    private static let emailDomains = "gmail.com yahoo.com hotmail.com email.com live.com me.com mac.com aol.com fastmail.com mail.com".split(" ")
...
public extension Array {
    ...
    public var randomElement: Element {
		return self[Int.random(lower: 0, count - 1)]
    }
